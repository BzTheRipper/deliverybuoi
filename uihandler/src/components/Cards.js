...
export default function Cards() {
    return (
        <div>
            <div className="card m-5" style={{ width: "24rem", height: "450px", objectFit: "contain !important" }}>
                <div className="card-whole" style={{ height: "250px" }}>
                    <img
                        src={Pizza}
                ...
                <div className="card-body">
                    ...
                    <Link to="/login" class="btn btn-primary m-3">Add to cart</Link>
                </div>
            </div>
